...
Última verificación: 32 pruebas ejecutadas, sin fallos ni errores, con Java 17 y Spring Boot 4.1.0. La suite incluye comprobaciones HTTP de rutas públicas y respuestas 401/403 por permisos.
