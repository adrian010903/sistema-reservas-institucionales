...
function WorkspaceApp() {
  ...
  function renderReservePage() {
    ...
    const placeCover = place => spaces.find(space => String(space.lugarId) === String(place.id) && space.imagenUrl)?.imagenUrl
