...
function WorkspaceApp() {
  ...
  function renderAdminDashboard() {
    ...
    const chartStyle = { background: `conic-gradient(#00b0c6 0 ${confirmedEnd}%, #2c1261 ${confirmedEnd}% ${approvedEnd}%, #ed1a39 ${approvedEnd}% ${pendingEnd}%, #c1c5d3 ${pendingEnd}% 100%)` }
